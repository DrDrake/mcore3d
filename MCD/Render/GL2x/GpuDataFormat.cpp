...
GpuDataFormat GpuDataFormat::get(const StringHash& name)
{
	...
	// 3 components
	{ FixString("uintRGB8"), GL_RGB8, GL_UNSIGNED_BYTE, GL_RGB, sizeof(uint8_t), 3 },
	{ FixString("uintBGR8"), GL_RGB8, GL_UNSIGNED_BYTE, GL_BGR, sizeof(uint8_t), 3 },
	{ FixString("uintB5G6R5"), GL_RGB5, GL_UNSIGNED_SHORT_5_6_5, GL_RGB, 0, 3 },

	// 4 components
	{ FixString("uintRGBA8"), GL_RGBA8, GL_UNSIGNED_BYTE, GL_RGBA, sizeof(uint8_t), 4 },
	{ FixString("uintBGRA8"), GL_RGBA8, GL_UNSIGNED_BYTE, GL_BGRA, sizeof(uint8_t), 4 },
	{ FixString("uintBGR5A1"), GL_RGB5_A1, GL_UNSIGNED_SHORT_1_5_5_5_REV, GL_BGRA, 0, 4 },
...
//	{ FixString("depth24"), GL_DEPTH24_STENCIL8, GL_UNSIGNED_INT, GL_DEPTH_STENCIL, 3 * sizeof(uint8_t), 1 },
	...
	// Compressed
	{ FixString("dxt1"), GL_COMPRESSED_RGBA_S3TC_DXT1_EXT, -1, -1, 0, 0 },
	{ FixString("dxt3"), GL_COMPRESSED_RGBA_S3TC_DXT3_EXT, -1, -1, 0, 0 },
	{ FixString("dxt5"), GL_COMPRESSED_RGBA_S3TC_DXT5_EXT, -1, -1, 0, 0 },
	};
