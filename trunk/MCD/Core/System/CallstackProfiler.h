#ifndef __MCD_CORE_SYSTEM_CALLSTACKPROFILER__
#define __MCD_CORE_SYSTEM_CALLSTACKPROFILER__
 ...
 */
class MCD_ABSTRACT_CLASS MCD_CORE_API CallstackNode : Noncopyable
{
public:
...
#endif	// __MCD_CORE_SYSTEM_CALLSTACKPROFILER__
