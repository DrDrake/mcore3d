...
/// Create a std::string with printf like formatting, may not be high performance but handy.
MCD_CORE_API std::string formatStr(sal_format_guard const char* fmt, ...);
