...
LDLIBSOPTIONS=-Wl,-rpath ../Core/Release/GNU-Linux-x86 -L../Core/Release/GNU-Linux-x86 -lCore

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk Release/${PLATFORM}/libRender.so

Release/${PLATFORM}/libRender.so: ../Core/Release/GNU-Linux-x86/libCore.so

Release/${PLATFORM}/libRender.so: ${OBJECTFILES}
	${MKDIR} -p Release/${PLATFORM}
	${LINK.cc} -shared -o Release/${PLATFORM}/libRender.so -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/Components/CameraComponent.o: Components/CameraComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/Components
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Components/CameraComponent.o Components/CameraComponent.cpp

${OBJECTDIR}/TgaLoader.o: TgaLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/TgaLoader.o TgaLoader.cpp
...
${OBJECTDIR}/Components/PickComponent.o: Components/PickComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/Components
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Components/PickComponent.o Components/PickComponent.cpp

${OBJECTDIR}/BackRenderBuffer.o: BackRenderBuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/BackRenderBuffer.o BackRenderBuffer.cpp

${OBJECTDIR}/MeshBuilder.o: MeshBuilder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/MeshBuilder.o MeshBuilder.cpp

${OBJECTDIR}/ModelPod.o: ModelPod.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ModelPod.o ModelPod.cpp

${OBJECTDIR}/Components/MeshComponent.o: Components/MeshComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/Components
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Components/MeshComponent.o Components/MeshComponent.cpp

${OBJECTDIR}/ProjectiveTexture.o: ProjectiveTexture.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ProjectiveTexture.o ProjectiveTexture.cpp

${OBJECTDIR}/RenderBuffer.o: RenderBuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/RenderBuffer.o RenderBuffer.cpp
...
${OBJECTDIR}/ShaderLoader.o: ShaderLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ShaderLoader.o ShaderLoader.cpp

${OBJECTDIR}/RenderTarget.o: RenderTarget.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/RenderTarget.o RenderTarget.cpp

${OBJECTDIR}/Max3dsLoader.o: Max3dsLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Max3dsLoader.o Max3dsLoader.cpp

${OBJECTDIR}/Components/RenderableComponent.o: Components/RenderableComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/Components
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Components/RenderableComponent.o Components/RenderableComponent.cpp

${OBJECTDIR}/MaterialProperty.o: MaterialProperty.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/MaterialProperty.o MaterialProperty.cpp
...
${OBJECTDIR}/TextureLoaderBase.o: TextureLoaderBase.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/TextureLoaderBase.o TextureLoaderBase.cpp

${OBJECTDIR}/Model.o: Model.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Model.o Model.cpp
...
${OBJECTDIR}/ResourceLoaderFactory.o: ResourceLoaderFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ResourceLoaderFactory.o ResourceLoaderFactory.cpp

${OBJECTDIR}/Frustum.o: Frustum.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Frustum.o Frustum.cpp

${OBJECTDIR}/GlWindow.o: GlWindow.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/GlWindow.o GlWindow.cpp

${OBJECTDIR}/JpegLoader.o: JpegLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/JpegLoader.o JpegLoader.cpp

${OBJECTDIR}/EffectLoader.o: EffectLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/EffectLoader.o EffectLoader.cpp

${OBJECTDIR}/DdsLoader.o: DdsLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/DdsLoader.o DdsLoader.cpp

${OBJECTDIR}/Effect.o: Effect.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Effect.o Effect.cpp

${OBJECTDIR}/BitmapLoader.o: BitmapLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/BitmapLoader.o BitmapLoader.cpp
...
${OBJECTDIR}/Material.o: Material.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Material.o Material.cpp
...
${OBJECTDIR}/ShaderProgram.o: ShaderProgram.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ShaderProgram.o ShaderProgram.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} Release/${PLATFORM}/libRender.so
