...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/libCore.so

dist/Debug/GNU-Linux-x86/libCore.so: ../../3Party/squirrel/dist/Debug/GNU-Linux-x86/libsquirrel.so

dist/Debug/GNU-Linux-x86/libCore.so: ${OBJECTFILES}
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/libCore.so
