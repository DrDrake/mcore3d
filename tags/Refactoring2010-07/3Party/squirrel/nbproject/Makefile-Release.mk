...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/libsquirrel.so

dist/Release/GNU-Linux-x86/libsquirrel.so: ${OBJECTFILES}
...
${OBJECTDIR}/sqstdlib/sqstdblob.o: nbproject/Makefile-${CND_CONF}.mk sqstdlib/sqstdblob.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/sqstdlib/sqstdblob.o sqstdlib/sqstdblob.cpp

${OBJECTDIR}/squirrel/sqcompiler.o: nbproject/Makefile-${CND_CONF}.mk squirrel/sqcompiler.cpp 
	${MKDIR} -p ${OBJECTDIR}/squirrel
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/squirrel/sqcompiler.o squirrel/sqcompiler.cpp

${OBJECTDIR}/squirrel/sqbaselib.o: nbproject/Makefile-${CND_CONF}.mk squirrel/sqbaselib.cpp 
	${MKDIR} -p ${OBJECTDIR}/squirrel
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/squirrel/sqbaselib.o squirrel/sqbaselib.cpp

${OBJECTDIR}/sqstdlib/sqstdrex.o: nbproject/Makefile-${CND_CONF}.mk sqstdlib/sqstdrex.cpp 
	${MKDIR} -p ${OBJECTDIR}/sqstdlib
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/sqstdlib/sqstdrex.o sqstdlib/sqstdrex.cpp

${OBJECTDIR}/squirrel/sqlexer.o: nbproject/Makefile-${CND_CONF}.mk squirrel/sqlexer.cpp 
	${MKDIR} -p ${OBJECTDIR}/squirrel
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/squirrel/sqlexer.o squirrel/sqlexer.cpp

${OBJECTDIR}/sqstdlib/sqstdio.o: nbproject/Makefile-${CND_CONF}.mk sqstdlib/sqstdio.cpp 
	${MKDIR} -p ${OBJECTDIR}/sqstdlib
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/sqstdlib/sqstdio.o sqstdlib/sqstdio.cpp

${OBJECTDIR}/squirrel/sqclass.o: nbproject/Makefile-${CND_CONF}.mk squirrel/sqclass.cpp 
	${MKDIR} -p ${OBJECTDIR}/squirrel
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/squirrel/sqclass.o squirrel/sqclass.cpp

${OBJECTDIR}/sqstdlib/sqstdmath.o: nbproject/Makefile-${CND_CONF}.mk sqstdlib/sqstdmath.cpp 
	${MKDIR} -p ${OBJECTDIR}/sqstdlib
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/sqstdlib/sqstdmath.o sqstdlib/sqstdmath.cpp

${OBJECTDIR}/squirrel/sqtable.o: nbproject/Makefile-${CND_CONF}.mk squirrel/sqtable.cpp 
	${MKDIR} -p ${OBJECTDIR}/squirrel
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/squirrel/sqtable.o squirrel/sqtable.cpp

${OBJECTDIR}/squirrel/sqdebug.o: nbproject/Makefile-${CND_CONF}.mk squirrel/sqdebug.cpp 
	${MKDIR} -p ${OBJECTDIR}/squirrel
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/squirrel/sqdebug.o squirrel/sqdebug.cpp

${OBJECTDIR}/sqstdlib/sqstdaux.o: nbproject/Makefile-${CND_CONF}.mk sqstdlib/sqstdaux.cpp 
	${MKDIR} -p ${OBJECTDIR}/sqstdlib
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/sqstdlib/sqstdaux.o sqstdlib/sqstdaux.cpp

${OBJECTDIR}/squirrel/sqfuncstate.o: nbproject/Makefile-${CND_CONF}.mk squirrel/sqfuncstate.cpp 
	${MKDIR} -p ${OBJECTDIR}/squirrel
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/squirrel/sqfuncstate.o squirrel/sqfuncstate.cpp

${OBJECTDIR}/squirrel/sqobject.o: nbproject/Makefile-${CND_CONF}.mk squirrel/sqobject.cpp 
	${MKDIR} -p ${OBJECTDIR}/squirrel
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/squirrel/sqobject.o squirrel/sqobject.cpp

${OBJECTDIR}/squirrel/sqvm.o: nbproject/Makefile-${CND_CONF}.mk squirrel/sqvm.cpp 
	${MKDIR} -p ${OBJECTDIR}/squirrel
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/squirrel/sqvm.o squirrel/sqvm.cpp

${OBJECTDIR}/sqstdlib/sqstdstream.o: nbproject/Makefile-${CND_CONF}.mk sqstdlib/sqstdstream.cpp 
	${MKDIR} -p ${OBJECTDIR}/sqstdlib
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/sqstdlib/sqstdstream.o sqstdlib/sqstdstream.cpp

${OBJECTDIR}/squirrel/sqapi.o: nbproject/Makefile-${CND_CONF}.mk squirrel/sqapi.cpp 
	${MKDIR} -p ${OBJECTDIR}/squirrel
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/squirrel/sqapi.o squirrel/sqapi.cpp

${OBJECTDIR}/sqstdlib/sqstdstring.o: nbproject/Makefile-${CND_CONF}.mk sqstdlib/sqstdstring.cpp 
	${MKDIR} -p ${OBJECTDIR}/sqstdlib
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/sqstdlib/sqstdstring.o sqstdlib/sqstdstring.cpp

${OBJECTDIR}/squirrel/sqstate.o: nbproject/Makefile-${CND_CONF}.mk squirrel/sqstate.cpp 
	${MKDIR} -p ${OBJECTDIR}/squirrel
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/squirrel/sqstate.o squirrel/sqstate.cpp

${OBJECTDIR}/squirrel/sqmem.o: nbproject/Makefile-${CND_CONF}.mk squirrel/sqmem.cpp 
	${MKDIR} -p ${OBJECTDIR}/squirrel
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/squirrel/sqmem.o squirrel/sqmem.cpp

${OBJECTDIR}/sqstdlib/sqstdsystem.o: nbproject/Makefile-${CND_CONF}.mk sqstdlib/sqstdsystem.cpp 
	${MKDIR} -p ${OBJECTDIR}/sqstdlib
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/sqstdlib/sqstdsystem.o sqstdlib/sqstdsystem.cpp
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/libsquirrel.so
